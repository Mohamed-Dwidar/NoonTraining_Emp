                                                ...
                                                <div class="form-group mt-1">
                                                    <label>
                                                        <input type="checkbox" name="can_view_work_regulations" value="1"
                                                            {{ old('can_view_work_regulations', $employee->can_view_work_regulations) ? 'checked' : '' }}>
                                                            ...
                                                            <tbody>
                                                                @foreach ($commissions as $commission)
                                                                    @php
                                                                        ...
                                                                        $defaultType = $existing->type ?? $commission->type;
                                                                        $defaultValue = $existing->value ?? $commission->value;
                                                                    @endphp
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control form-control-sm"
                                                                                ...
                                                                                <option value="fixed"
                                                                                    {{ old('commissions.' . $commission->id . '.type', $defaultType) == 'fixed' ? 'selected' : '' }}>
                                                                                    قيمة ثابتة</option>
                                                                                <option value="percentage"
                                                                                    {{ old('commissions.' . $commission->id . '.type', $defaultType) == 'percentage' ? 'selected' : '' }}>
                                                                                    نسبة مئوية</option>
                                                                            </select>
                                                                        </td>
                                                                        <td>
                                                                            <input type="number" step="0.01" min="0"
                                                                                ...
                                                                                value="{{ old('commissions.' . $commission->id . '.value', $defaultValue) }}">
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
