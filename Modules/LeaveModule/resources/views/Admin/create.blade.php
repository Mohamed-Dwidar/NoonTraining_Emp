...
@section('title') إضافة إجازة @endsection

@section('content')
<div class="content-wrapper container-fluid">

    <div class="content-header mb-2">
        <h3><i class="fa fa-plus-circle"></i> &nbsp; إضافة إجازة جديدة</h3>
    </div>
            ...
            <form class="card-form side-form" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1 col-sm-12 col-6">
                        ...
                        <div class="form-group">
                            <span id="daysDisplay" class="form-control text-center bg-light">—</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 mt-1">
                    <a href="{{ route('admin.leaves.index') }}" class="btn btn-secondary">إلغاء</a>
...
(function () {
    ...
    function populateDepts(branchId, selectedDeptId) {
        ...
        if (selectedDeptId) {
            populateEmployees(selectedDeptId, oldEmpId);
        } else {
            resetEmployees();
        }
    }
    ...
    if (oldBranchId) {
        populateDepts(oldBranchId, oldDeptId);
    }
