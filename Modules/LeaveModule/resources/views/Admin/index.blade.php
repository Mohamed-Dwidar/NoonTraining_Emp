            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-12" style="text-align: left;">
                        <a class="btn btn-success round btn-min-width mr-1 mb-1" href="{{ route('admin.leaves.create') }}"
                            role="button">تسجيل إجازة
                            جديدة</a>
                    </div>
                </div>
            </div>
                                ...
                                @foreach ($leaves as $i => $leave)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.leaves.destroy', $leave->id) }}"
                                                class="d-inline" onsubmit="return confirm('هل تريد حذف هذه الإجازة؟')">
                                                @csrf
                                                @method('DELETE')
