                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <form class="card-form side-form" method="POST"
                                        action="{{ route(Auth::getDefaultDriver() . '.payrolls.update') }}"
                                            ...
                                            <div class="col-lg-4 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text"
                                                        ...
                                                        id="name" name="name" value="{{ old('name', $payroll->name) }}">
                                                    @error('name')
                                            ...
                                            <div class="col-lg-4 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text"
                                                        ...
                                                        id="job" name="job" value="{{ old('job', $payroll->job) }}">
                                                    @error('job')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control @error('branch_id') is-invalid @enderror"
                                                        ...
                                                        @foreach($branches as $branch)
                                                            <option value="{{ $branch->id }}" {{ old('branch_id', $payroll->branch_id) == $branch->id ? 'selected' : '' }}>
                                                                {{ $branch->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" step="0.01" min="0"
                                                        ...
                                                        id="basic_salary" name="basic_salary" value="{{ old('basic_salary', $payroll->basic_salary) }}">
                                                    @error('basic_salary')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" min="1" max="31"
                                                        ...
                                                        id="monthly_working_days" name="monthly_working_days" value="{{ old('monthly_working_days', $payroll->monthly_working_days) }}">
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" min="1" max="24"
                                                        ...
                                                        id="daily_working_hours" name="daily_working_hours" value="{{ old('daily_working_hours', $payroll->daily_working_hours) }}">
                                        ...
                                        <div class="col-12 mt-1">
                                            <a href="{{ route(Auth::getDefaultDriver() . '.payrolls.index') }}"
...
(function () {
    ...
    const deptsByBranchBase = "{{ url('admin/payroll/departments-by-branch') }}";
    const currentDeptId     = "{{ old('department_id', $payroll->department_id) }}";
