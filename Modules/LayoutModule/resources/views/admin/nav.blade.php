            ...
            <ul class="top-menu menu-eff text-right">
                    ...
                    <ul class="dropdown">
                        ...
                        <li>
                            <a href="{{ route('admin.leaves.index') }}"
                                class="@if (Request::segment(2) == 'leave') active @endif">
                                <i class="fa fa-ban"></i> الإجازات
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.bonuses.index') }}"
                                class="@if (Request::segment(2) == 'bonus') active @endif">
                                <i class="fa fa-gift"></i> المكافآت
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.deductions.index') }}"
                                class="@if (Request::segment(2) == 'discount') active @endif">
                                <i class="fa fa-minus-circle"></i> الجزاءات والخصومات
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.tasks.index') }}"
                                class="@if (Request::segment(2) == 'task') active @endif">
                        ...
                        <li>
                            <a href="{{ route('admin.students.index') }}"
                                ...
                                <i class="fa fa-graduation-cap"></i> تسجيل الطلاب <small
                                    class="text-muted">(للمعهد)</small>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.employees.index') }}"
                        class="@if (Request::segment(2) == 'employee') active @endif">
                ...
                <li class="nav-item">
                     <a href="{{ route('admin.payrolls.index') }}">
                        ...
                        <span class="menu-title">الرواتب</span>
                    </a>
                </li>
                    ...
                    <ul class="dropdown">
                        <li>
                            <a href="{{ route('admin.branches.index') }}"
                                class="@if (Request::segment(2) == 'branch') active @endif">
                                <i class="fa fa-code-fork"></i> الفروع
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.departments.index') }}"
                                class="@if (Request::segment(2) == 'department') active @endif">
                                <i class="fa fa-sitemap"></i> الأقسام
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.violations.index') }}"
                                class="@if (Request::segment(2) == 'violation') active @endif">
                                <i class="fa fa-exclamation-triangle"></i> المخالفات
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.branches.work-regulations.list') }}"
                                class="@if (Request::segment(2) == 'branches' && Request::segment(3) == 'work-regulations') active @endif">
