...
@section('title') إضافة مهمة @endsection

@section('content')
<div class="content-wrapper container-fluid">

    <div class="content-header mb-2">
        <h3><i class="fa fa-plus-circle"></i> &nbsp; إضافة مهمة جديدة</h3>
    </div>
    ...
    <div class="card">
        <div class="card-content">
            <form class="card-form side-form" method="POST" action="{{ route('admin.tasks.store') }}">
                @csrf
