                ...
                <div class="row">
                    <div class="col-lg-12" style="text-align: left;">
                        <a class="btn btn-success round btn-min-width mr-1 mb-1"
                            href="{{ route('admin.bonuses.create', ['month' => $month]) }}" role="button">تسجيل مكافأة
                            جديدة</a>
                    </div>
                </div>
            </div>
                                ...
                                @foreach ($bonuses as $i => $bonuse)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('admin.bonuses.destroy', $bonuse->id) }}"
                                                class="d-inline" onsubmit="return confirm('هل تريد حذف هذه المكافأة؟')">
                                                @csrf
                                                @method('DELETE')
