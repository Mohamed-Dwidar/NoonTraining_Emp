...
@section('title') إضافة طالب @endsection

@section('content')
<div class="content-wrapper container-fluid">

    <div class="content-header mb-2">
        <h3><i class="fa fa-plus-circle"></i> &nbsp; إضافة طالب جديد</h3>
    </div>
    ...
    <div class="card">
        <div class="card-content">
            <form class="card-form side-form" method="POST" action="{{ route('admin.students.store') }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-12 col-6">
                        <label>المتبقي</label>
                        <div class="form-group">
                            <span id="remainingDisplay" class="form-control text-center bg-light">0</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12 col-6">
