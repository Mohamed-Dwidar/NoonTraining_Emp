...
@section('content')
    <div class="content-wrapper container-fluid">
        ...
        <div class="content-header mb-2">
            <h3><i class="fa fa-plus-circle"></i> &nbsp; إضافة نوع مخالفة</h3>
        </div>
        ...
        <div class="card">
            <div class="card-content">
                <form class="card-form side-form" method="POST" action="{{ route('admin.violations.store') }}">
                    @csrf
                    ...
                    @php
                        $defaultRepeats = old('repeats', [['repeat_number' => 1, 'deduction_amount' => '']]);
                    @endphp
                    ...
                    <table style="border-collapse:separate; border-spacing:0 6px;">
                        ...
                        <tbody id="repeatsContainer">
                            @foreach ($defaultRepeats as $i => $row)
                                    ...
                                    <td style="padding: 0 8px 0 0;">
                                        <div class="input-group input-group-sm" style="width:160px;">
                                            <input type="number" name="repeats[{{ $i }}][deduction_amount]"
                                                   class="form-control rpt-amount" step="0.01" min="0"
                                                   value="{{ $row['deduction_amount'] }}" placeholder="0.00" required>
